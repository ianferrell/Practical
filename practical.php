...
//// ADMIN DASHBOARD FOR CONTACT FORM ENTRIES

function contact_form_menu() {
    add_menu_page( 'Contact Form Entries', 'Contact Form Entries', 'manage_options', 'practical/dash.php', 'contact_form_admin_page', 'dashicons-email', 6  );
}
